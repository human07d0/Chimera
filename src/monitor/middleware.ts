...
function calculateCost(promptTokens: number, cachedPromptTokens: number, completionTokens: number): number {
...
export function monitorMiddleware(req: Request, res: Response, next: NextFunction): void {
  ...
  res.end = function (...args: any[]): Response {
    ...
    const cost = calculateCost(inputTokens, cachedPromptTokens, outputTokens);
